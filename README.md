...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/langcodes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14100&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/langcodes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `langcodes` can be installed with:

```
conda install langcodes
```

It is possible to list all of the versions of `langcodes` available on your platform with:
